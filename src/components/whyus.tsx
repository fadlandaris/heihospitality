      ...
      <div className='max-w-[1400px] mx-auto py-24 relative'>
          ...
          {servicesData.map((item, i) => {
            ...
            return (
              <Fadein key={i} delay={delay[item.id]}>
                <div className={`${item.id === servicesData.length - 1 ? 'bg-secondary border-border/30 border-2' : 'bg-[#121212] border-2 border-border/20'} rounded-lg p-6 cursor-pointer hover:scale-102 transition-all duration-600`}>
        ...
        <div className='mt-32 grid grid-cols-4'>
          ...
          <div>
            ...
            <Fadein delay={0.675}>
              <p className='mt-4 text-white/60 font-medium'>Temukan peluang karir di industri perhotelan global dengan pelatihan berkualitas, pengalaman praktik langsung di hotel, resor, atau kapal pesiar internasional</p>
            </Fadein>
          </div>
        </div>
      </div>
